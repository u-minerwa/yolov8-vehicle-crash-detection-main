...
class_list = ['Car', 'Accident', 'Bus', 'Truck', 'Bike'] 
...
statistics = {'Accident': 0, 'Bus': 0, 'Car': 0, 'Truck': 0, 'Bike': 0, 'TotalAccidentFrames': 0} 
...
while not video_finished:    
    ...
    stats_text = f"Accident: {statistics['Accident']}, Bus: {statistics['Bus']}, Car: {statistics['Car']}, Truck: {statistics['Truck']}, Bike: {statistics['Bike']}, TotalAccidentFrames: {total_accident_frames}" 
    ...
    for index,row in px.iterrows():
        ...
        if "Bike" in c: 
            cv2.rectangle(frame,(x1,y1),(x2,y2),(0,150,100),2)
            cvzone.putTextRect(frame,f'{c}',(x1,y1),1,1)
