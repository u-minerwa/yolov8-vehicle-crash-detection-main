...
PATH = 'F:\\newProgramm\\models\\model_16_m3_0.8888.pth'
...
if __name__ == "__main__":
    keypoint = KeyPoints(model_path="F:\\newProgramm\\models\\knn_model.pkl")

    video_folder_path = "F:\\1"
    label = "Fight"
                                    
    video_paths = [os.path.join(video_folder_path, file) for file in os.listdir(video_folder_path) if file.endswith(".mp4")]
    model = YOLO('F:\\newProgramm\\models\\yolov8x.pt')
